...
expedita consequatur consequatur dolores quia eos et placeat`}],Nc=[{id:1,name:"Leanne Graham",username:"Bret",email:"Sincere@april.biz"},{id:2,name:"Ervin Howell",username:"Antonette",email:"Shanna@melissa.tv"},{id:3,name:"Clementine Bauch",username:"Samantha",email:"Nathan@yesenia.net"},{id:4,name:"Patricia Lebsack",username:"Karianne",email:"Julianne.OConner@kory.org"},{id:5,name:"Chelsey Dietrich",username:"Kamren",email:"Lucio_Hettinger@annie.ca"},{id:6,name:"Mrs. Dennis Schulist",username:"Leopoldo_Corkery",email:"Karley_Dach@jasper.info"},{id:7,name:"Kurtis Weissnat",username:"Elwyn.Skiles",email:"Telly.Hoeger@billy.biz"},{id:8,name:"Nicholas Runolfsdottir V",username:"Maxime_Nienow",email:"Sherwood@rosamond.me"},{id:9,name:"Glenna Reichert",username:"Delphine",email:"Chaim_McDermott@dana.io"},{id:10,name:"Clementina DuBuque",username:"Moriah.Stanton",email:"Rey.Padberg@karina.biz"}],Pc=[{postId:1,id:1,name:"id labore ex et quam laborum",email:"Eliseo@gardner.biz",body:`laudantium enim quasi est quidem magnam voluptate ipsam eos
...
aut aut aut maxime quia temporibus ut omnis`}],Lc=({user:e})=>R.jsx("a",{className:"UserInfo",href:`mailto: ${e.email} `,children:e.name}),Tc=({comment:e})=>R.jsxs("div",{className:"CommentInfo",children:[R.jsxs("div",{className:"CommentInfo__title",children:[R.jsx("strong",{className:"CommentInfo__name",children:e.name})," by ",R.jsx("a",{className:"CommentInfo__email",href:`mailto:${e.email}`,children:e.email})]}),R.jsx("div",{className:"CommentInfo__body",children:e.body})]}),Mc=({postId:e,comments:t})=>{const i=t.filter(n=>n.postId===e);return R.jsx("div",{className:"CommentList",children:i.length===0?R.jsxs(R.Fragment,{children:[R.jsx("hr",{}),R.jsx("p",{children:"No comments yet"})]}):i.map(n=>R.jsx(Tc,{comment:n},n.id))})};function Ur(e){return Nc.find(t=>t.id===e)||null}const Rc=({post:e})=>R.jsxs("div",{className:"PostInfo",children:[R.jsxs("div",{className:"PostInfo__header",children:[R.jsx("h3",{className:"PostInfo__title",children:e.title}),R.jsxs("p",{children:[" Posted by  ",R.jsx(Lc,{user:Ur(e.userId)},Ur(e.userId).id)]})]}),R.jsx("p",{className:"PostInfo__body",children:e.body}),R.jsx(Mc,{postId:e.id,comments:Pc})]}),Dc=({posts:e})=>R.jsx("div",{className:"PostList",children:e.map(t=>R.jsx(Rc,{post:t},t.key))}),jc=()=>R.jsxs("section",{className:"App",children:[R.jsx("h1",{className:"App__title",children:"Static list of posts"}),R.jsx(Dc,{posts:zc})]});tm(document.getElementById("root")).render(R.jsx(jc,{}));
